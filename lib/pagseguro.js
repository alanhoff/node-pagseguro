...
(function() {
  ...
  pagseguro = (function() {
    ...
    pagseguro.prototype.addItem = function(item) {
      if (this.mode === 'subscription' || this.mode === 'sandbox-subscription') {
    ...
    pagseguro.prototype.send = function(callback) {
      ...
      switch (this.mode) {
        ...
        case 'subscription':
          ...
          break;
        case 'sandbox-subscription':
          options.uri = "https://ws.sandbox.uol.com.br/v2/pre-approvals/request?email=" + this.email + "&token=" + this.token;
          options.body = this.xml + xml.toXML({
            preApprovalRequest: this.obj
          });
          break;
