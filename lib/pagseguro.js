...
(function() {
  ...
  pagseguro = (function() {
    function pagseguro(email, token, debug) {
      this.email = email;
      this.token = token;
      this.debug = debug;
      this.obj = new Object;
    ...
    */
    ...
    pagseguro.prototype.send = function(callback) {
      var options;
      var debug_prefix = this.debug ? "sandbox." : "";

      options = {
        uri: "https://ws." + debug_prefix + "pagseguro.uol.com.br/v2/checkout?email=" + this.email + "&token=" + this.token,
        method: 'POST',
        headers: {
